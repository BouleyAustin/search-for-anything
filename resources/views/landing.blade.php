<x-guest-layout>
    ...
    <div id="features" class="relative bg-white py-8 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
            ...
            <p class="mt-5 max-w-prose mx-auto text-xl text-gray-500">SearchForAnything.io gives you the potential to turn your podcast into a massive growth engine and community builder! Check out some of the many benefits below.</p>
            <div class="mt-12">
                    ...
                    <div class="pt-6">
                        <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                            <div class="-mt-6">
                                ...
                                <p class="mt-5 text-base text-gray-500">SearchForAnything.io will automatically create a dedicated podcast episode page with transcript included to help people more easily find you on the internet! It also allows you to set SEO keywords, tags and more.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-6">
                        <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                            <div class="-mt-6">
                                ...
                                <p class="mt-5 text-base text-gray-500">SearchForAnything.io will automatically transcribe every new podcast episode, create a dedicate page, and add it to the search engine every time a new episode drops!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                ...
                <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
                    ...
                    <div class="col-span-1 py-8 px-8 bg-gray-50">
                        ...
                        <p class="text-sm mt-2 text-gray-600">Request BETA access! You'll also be able to be included in our podcast marketplace :)</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white">
        <div class="mb-36 max-w-7xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                <span class="block">Request Access Today!</span>
            </h2>
            <div class="mt-8 flex justify-center">
                <div class="inline-flex rounded-md shadow">
                    <a href="#explanation" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">Request BETA Access</a>
                </div>
