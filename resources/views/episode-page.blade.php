<body class="flex flex-col min-h-screen" style="{{ $pageDetails['background_color'] != null ? 'background-color: ' . $pageDetails['background_color'] : '' }}">
    ...
    <main class="flex-grow">
        <livewire:social-sharing-buttons :pageDetails="$pageDetails" :contentId="$content['id']"/>
        <div class="pt-8 lg:pt-12 m-2 sm:m-0">
    ...
    <footer class="mb-10 {{ count($transcript) ? '' : 'mt-36' }}">
        <div class="text-center {{ $pageDetails['text_color'] != null ? ($pageDetails['text_color'] == 'black' ? 'text-black' : 'text-white') : '' }}">
            ...
            <div class="flex gap-4 justify-center items-center text-gray-400">
                ...
                @if($pageDetails['link_instagram'] != null)
                    <div>
                        <a href="{{ $pageDetails['link_instagram'] }}" target="_blank">
                ...
                @endif
                @if($pageDetails['link_tiktok'] != null)
                    <div>
                        <a href="{{ $pageDetails['link_tiktok'] }}" target="_blank">
                ...
                @endif
                @if($pageDetails['link_youtube'] != null)
                    <div>
                        <a href="{{ $pageDetails['link_youtube'] }}" target="_blank">
                ...
                @endif
                @if($pageDetails['link_twitter'] != null)
                    <div>
                        <a href="{{ $pageDetails['link_twitter'] }}" target="_blank">
                ...
                @endif
                @if($pageDetails['link_facebook'] != null)
                    <div>
                        <a href="{{ $pageDetails['link_facebook'] }}" target="_blank">
                ...
                @endif
                @if($pageDetails['link_linkedin'] != null)
                    <div>
                        <a href="{{ $pageDetails['link_linkedin'] }}" target="_blank">
                ...
                @endif
                @if($pageDetails['link_url'] != null)
                    <div>
                        <a href="{{ $pageDetails['link_url'] }}" target="_blank">
