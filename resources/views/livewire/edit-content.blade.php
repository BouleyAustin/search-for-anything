        ...
        <x-slot name="content">
            ...
            <div class="mt-10 mb-3">
                ...
                <div class="mt-3 overflow-hidden rounded-lg flex items-center justify-left">
                    ...
                    <div class="pl-3">
                        <input wire:model="content.title" type="text" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 hover:border-blue-500 block w-48 sm:text-sm border-gray-300 rounded-md">
                ...
                <div class="mt-3 overflow-hidden rounded-lg flex items-center justify-left">
                    ...
                    <div class="pl-3">
                        <select wire:model="content.platform" class="mt-1 block w-48 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 hover:border-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                ...
                <div class="mt-3 overflow-hidden rounded-lg flex items-center justify-left">
                    ...
                    <div class="pl-3">
                        <select wire:model="content.show_cta" class="mt-1 block w-48 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 hover:border-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
