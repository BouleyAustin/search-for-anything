            ...
            <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                ...
                <div class="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                    ...
                    <div class="mt-3 sm:flex">
                        ...
                        <input wire:model="email" type="email" name="email" id="email" class="block w-full py-3 text-base rounded-md placeholder-gray-500 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:flex-1 border-gray-300" placeholder="Enter your email">
                        <button wire:click="addEmail" class="mt-3 w-full px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-800 shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:flex-shrink-0 sm:inline-flex sm:items-center sm:w-auto">Request Access</button>
                    </div>
                    <p class="mt-3 text-sm text-gray-500">
                        We care about the protection of your data. Read our
                        <a href="{{ route('policy.show') }}" class="font-medium text-gray-900 underline">Privacy Policy</a>.
                    </p>
                </div>
            </div>
